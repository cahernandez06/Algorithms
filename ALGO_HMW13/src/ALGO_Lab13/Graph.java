...
public class Graph {
	...
	private void loadMajorStructures() {
		...
		connectedComoonents = getConnectedComponents();
	...
	public boolean isConnected() {
        ...
        return connectedComoonents.size() == 1;
	}
    ...
    public LinkedList<Vertex> getListOfAdjacentVerts(Vertex v) {
        LinkedList<Vertex> theList = adjList.get(v);
        if (theList == null) {
    ...
    public boolean isBipartite() {
        OddCycle cycle = new OddCycle(this);
        isBipartite = !cycle.isGraphContainsOddCycle();
        return isBipartite;
    }
