package KnapSack_Probl2_1;

import java.io.*;
import java.util.*;

public class knapSack_Probl2_1 {
    ...
    public static List<Integer> knapsack(List<Integer> items, List<Integer> values, List<Integer> weights, int maxWeight) {
    	...
    	Collections.sort(itemList,new compareByWeight());
	...
	public static void main(String[] args) throws IOException {
        ...
        v.add(1);
        v.add(1);  //Changed value to break the algorith
        v.add(4);
