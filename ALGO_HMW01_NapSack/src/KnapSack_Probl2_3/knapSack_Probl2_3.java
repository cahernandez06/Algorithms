package KnapSack_Probl2_3;

import java.io.*;
import java.util.*;

public class knapSack_Probl2_3 {
    ...
    public static List<Integer> knapsack(List<Integer> items, List<Integer> values, List<Integer> weights, int maxWeight) {
    	...
    	class compareByWeightAvg implements Comparator<Item>{
    		public int compare(Item item1, Item item2) {
    	...
    	Comparator<Item> c = Collections.reverseOrder(new compareByWeightAvg()); 
	...
	public static void main(String[] args) throws IOException {
		List<Integer> ans= new ArrayList<Integer>();;
		int W = 12; //Maximum weight the knapsack can carry
